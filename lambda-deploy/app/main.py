...
from app.services.onechat import onechat_service, ChatResponse
from app.services.ai_backend_manager import ai_backend_manager
...
# Add root endpoint for web interface
@app.get("/")
async def root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "api_docs": "/docs",
            "health": "/api/onechat/status",
            "alerts": "/api/alerts",
            "chat": "/api/onechat/converse"
        },
        "instructions": "Visit /static/index.html for the web interface or /docs for API documentation"
    }
...
async def get_onechat_status():
    ...
    try:
        ...
        status_info = {
            ...
            "test_chat_successful": None,  # Removed expensive test chat call
            "last_test_conversation_id": None,
