...
class OneChatService:
    ...
    def get_agents(self) -> List[Agent]:
        ...
        try:
            response = self._make_request('GET', '/api/chat/agents', timeout=10)
            agents = []
    ...
    def create_agent(self, agent_id: str, name: str, description: str, 
        ...
        try:
            ...
            self._make_request('POST', '/api/chat/agents', agent_data)
    ...
    def get_agent(self, agent_id: str) -> Optional[Agent]:
        ...
        try:
            response = self._make_request('GET', f'/api/chat/agents/{agent_id}')
    ...
    def chat(self, input_text: str, conversation_id: Optional[str] = None, 
        ...
        try:
            ...
            response = self._make_request('POST', '/api/chat/converse', chat_data, timeout=timeout)
    ...
    def get_tools(self) -> List[Dict[str, Any]]:
        ...
        try:
            response = self._make_request('GET', '/api/chat/tools')
            return response.get('results', [])
